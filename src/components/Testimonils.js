...
function Testimonils() {
  var items = [
    ...
    I have had the pleasure (and good fortune) of working with  Damini during my campus-wide Enterprise IWMS implementation. \
    She is everything that you could ask in an employee and \
    I hope she stays with us after her student work is over. She works very well with our staff  \
    and can handle direction from many “bosses”. She has a great personality and is a pleasure to work with every day. \
    ...
    Damini has been a welcomed addition to our  Facilities Department at Illinois Tech. In the short quarter  \
    that she has been a student employee with us  she has been a great source for new ideas and has proven  \
    her willingness to learn. She has shown an impressive ability  to adapt to departmental needs in order to quickly \
    ...
    In just over 4 months, Damini has made an impact that simply  can’t be overstated. Beginning with her interview,  \
    she demonstrated her aptitude for problem solving by diagnosing  and addressing a technical issue for our \
